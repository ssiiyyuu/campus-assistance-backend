...
import com.siyu.server.service.flowable.HolidayService;
...
@Api(tags = "工作流——请假流程")
@RestController("/flowable/holiday")
public class HolidayController extends FlowableBaseController {
    ...
    public R<String> studentCreate(@RequestBody @Valid HolidayVO.Create create) {
        ...
        String assigneeId = getAssignee(user, "年级辅导员", DepartmentLevel.GRADE).getId();
